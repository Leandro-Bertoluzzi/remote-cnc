...
from core.utilities.grbl.types import ModalGroup, GrblError
...
GRBL_ALARMS: list[GrblError] = [
    ...
    },
    {
        'code': 10,
        'message': 'Homing fail',
        'description': 'Homing fail. Second dual axis limit switch failed to trigger within configured search distance after first. Try increasing trigger fail distance or check wiring.'
    }
]
