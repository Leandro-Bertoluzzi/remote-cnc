...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            (
                "GrblMsgStartup",
                {
                    "firmware": "Grbl",
                    "version": "1.1h",
                    "message": ": LongMill build ['$' for help]",
                    "raw": "Grbl 1.1h: LongMill build ['$' for help]",
                },
            ),
        ),
        (
            ...
            (
                "GrblMsgStartup",
                {
                    "firmware": "Grbl",
                    "version": "1.1h",
                    "message": " ['$' for help] LongMill build Feb 25, 2020",
                    "raw": "Grbl 1.1h ['$' for help] LongMill build Feb 25, 2020",
                },
            ),
        ),
        (
            ...
            (
                "GrblMsgStartup",
                {
                    "firmware": "myCustomGrbl",
                    "version": "2.0.0",
                    "message": " ['$' for help]",
                    "raw": "myCustomGrbl 2.0.0 ['$' for help]",
                },
            ),
        ),
        (
        ...
        (
            ...
            (
                "GrblMsgVersion",
                {"version": "1.1d.20161014", "comment": "", "raw": "[VER:1.1d.20161014:]"},
            ),
        ),
        (
            "[OPT:,15,128]",
        ...
        (
            "$N0=G54 G00 G10",
            (
                "GrblMsgUserDefinedStartup",
                {"name": "$N0", "value": "G54 G00 G10", "raw": "$N0=G54 G00 G10"},
            ),
        ),
        (
            "$10=100.200",
        ...
        ("[TLO:0.000]", ("GrblMsgParams", {"name": "TLO", "value": 0.000, "raw": "[TLO:0.000]"})),
        (
        ...
        (
            ...
            (
                ...
                {
                    "name": "PRB",
                    "value": {"x": 0.000, "y": 0.000, "z": 0.000, "result": True},
        ...
        (
            (
                "<Hold:0|MPos:5.000,2.000,0.000|WPos:5.000,2.000,0.000|FS:0.0,0|"
                "WCO:0.000,0.000,0.000|Pn:XYZPDHRS|Bf:15,128|Ln:90|Ov:100,100,100|A:SFM>"
            ),
            (
                "GrblMsgStatus",
                {
                    ...
                    "raw": (
                        "<Hold:0|MPos:5.000,2.000,0.000|WPos:5.000,2.000,0.000|FS:0.0,0|"
                        "WCO:0.000,0.000,0.000|Pn:XYZPDHRS|Bf:15,128|Ln:90|"
                        "Ov:100,100,100|A:SFM>"
                    ),
                },
            ),
        ),
        ("invalid", (None, {"raw": "invalid"})),
    ],
)
