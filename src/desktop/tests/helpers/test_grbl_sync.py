...
class TestGrblSync:
    ...
    def test_grbl_sync_message_received(self, qtbot: QtBot, mocker: MockerFixture):
        ...
        mocker.patch.object(self.grbl_controller.grbl_monitor, "get_log", return_value="A message")
    ...
    def test_grbl_sync_grbl_failed(self, qtbot: QtBot, mocker: MockerFixture):
        # Mock GRBL controller methods
        mocker.patch.object(self.grbl_controller.grbl_status, "failed", return_value=True)
        mocker.patch.object(
            self.grbl_controller.grbl_status, "get_error_message", return_value="An error message"
        )
        ...
        # Assertions
        assert self.grbl_sync._has_error is True
    ...
    def test_grbl_sync_grbl_recovers_from_failed(self, qtbot: QtBot, mocker: MockerFixture):
        ...
        # Mock GRBL controller methods
        mocker.patch.object(self.grbl_controller.grbl_status, "failed", return_value=False)
        ...
        # Assertions
        assert self.grbl_sync._has_error is False
