...
from manager.adapters.desktop.presentation.components.cards.MsgCard import MsgCard
...
from manager.adapters.desktop.presentation.components.dialogs.TaskDataDialog import TaskDataDialog
