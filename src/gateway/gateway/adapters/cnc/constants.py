"""GRBL-specific constants — firmware protocol definitions."""

from enum import Enum

from gateway.adapters.cnc.types import GrblError, ModalGroup
...
GRBL_ERRORS: list[GrblError] = [
    ...
    },
    {
        ...
        "description": (
            "No axis words found in block for g-code command or current"
            " modal state which requires them."
        ),
    },
    {
        "code": 27,
...
GRBL_ALARMS: list[GrblError] = [
    {
        ...
        "message": "Hard limit",
        "description": (
            "Hard limit has been triggered. Machine position is likely"
            " lost due to sudden halt. Re-homing is highly recommended."
        ),
    },
    {
        "code": 2,
    ...
    },
    {
        ...
        "description": (
            "Reset while in motion. Machine position is likely lost due"
            " to sudden halt. Re-homing is highly recommended."
        ),
    },
    {
        "code": 4,
        "message": "Probe fail",
        "description": (
            "Probe fail. Probe is not in the expected initial state"
            " before starting probe cycle when G38.2 and G38.3 is not"
    ...
    },
    {
        ...
        "message": "Probe fail",
        "description": (
            "Probe fail. Probe did not contact the workpiece within the"
    ...
    },
    {
        ...
        "message": "Homing fail",
        "description": (
            "Homing fail. Could not find limit switch within search"
            " distances. Try increasing max travel, decreasing pull-off"
            " distance, or check wiring."
        ),
    },
    {
        "code": 10,
        "message": "Homing fail",
        "description": (
            "Homing fail. Second dual axis limit switch failed to trigger"
            " within configured search distance after first. Try"
            " increasing trigger fail distance or check wiring."
        ),
    },
]
...
GRBL_SETTINGS = [
    ...
    },
    {
        ...
        "units": "milliseconds",
        "description": (
            "Sets a short hold delay when stopping to let dynamics"
            " settle before disabling steppers. Value 255 keeps motors"
    ...
    },
    {
        ...
        "units": "millimeters",
        "description": (
            "Sets the G2 and G3 arc tracing accuracy based on radial error."
            " Beware: A very small value may effect performance."
        ),
    },
    {
        "setting": "$13",
        ...
        "units": "boolean",
        "description": (
            "Enables inch units when returning any position and rate value that is"
    ...
    },
    {
        ...
        "units": "boolean",
        "description": (
            "Enables soft limits checks within machine travel and sets"
            " alarm when exceeded. Requires homing."
        ),
    },
    {
        "setting": "$21",
        ...
        "units": "boolean",
        "description": (
            "Enables hard limits. Immediately halts motion and throws an"
            " alarm when switch is triggered."
        ),
    },
    {
        "setting": "$22",
    ...
    },
    {
        ...
        "units": "mask",
        "description": (
            "Homing searches for a switch in the positive direction."
            " Set axis bit (00000ZYX) to search in negative direction."
        ),
    },
    {
        "setting": "$24",
    ...
    },
    {
        ...
        "units": "millimeters",
        "description": (
            "Retract distance after triggering switch to disengage it."
            " Homing will fail if switch isn't cleared."
        ),
    },
    {
        "setting": "$30",
    ...
    },
    {
        ...
        "units": "boolean",
        "description": (
            "Enables laser mode. Consecutive G1/2/3 commands will not"
            " halt when spindle speed is changed."
        ),
    },
    {
        "setting": "$100",
    ...
    },
    {
        ...
        "units": "mm/sec^2",
        "description": (
            "X-axis acceleration. Used for motion planning to not exceed"
            " motor torque and lose steps."
        ),
    },
    {
        "setting": "$121",
        ...
        "units": "mm/sec^2",
        "description": (
            "Y-axis acceleration. Used for motion planning to not exceed"
            " motor torque and lose steps."
        ),
    },
    {
        ...
        "units": "mm/sec^2",
        "description": (
            "Z-axis acceleration. Used for motion planning to not exceed"
            " motor torque and lose steps."
        ),
    },
    {
        ...
        "units": "millimeters",
        "description": (
            "Maximum X-axis travel distance from homing switch. Determines"
            " valid machine space for soft-limits and homing search distances."
        ),
    },
    {
        "setting": "$131",
        ...
        "units": "millimeters",
        "description": (
            "Maximum Y-axis travel distance from homing switch. Determines"
            " valid machine space for soft-limits and homing search distances."
        ),
    },
    {
        ...
        "units": "millimeters",
        "description": (
            "Maximum Z-axis travel distance from homing switch. Determines"
            " valid machine space for soft-limits and homing search distances."
        ),
    },
]
