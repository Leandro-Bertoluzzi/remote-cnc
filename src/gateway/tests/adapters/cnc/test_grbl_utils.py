...
from gateway.adapters.cnc.utils import (
    build_jog_command,
    get_grbl_setting,
    is_setting_update_command,
)
        ...
        (
            {
                ...
                "feedrate": 0.00,
                "units": None,
                "distance_mode": JogDistanceMode.ABSOLUTE,
                "machine_coordinates": False,
            },
        ...
        (
            {
                ...
                "feedrate": 0.00,
                "units": None,
                "distance_mode": JogDistanceMode.INCREMENTAL,
                "machine_coordinates": False,
            },
            "$J=G91 X1.0 Y2.0",
        ),
