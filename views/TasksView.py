...
class TasksView(QWidget):
    def __init__(self, parent=None):
        ...
        self.files = [{'id': file.id, 'name': file.file_name} for file in getAllFilesFromUser(2)]
    ...
    def createTask(self):
        ...
        if taskDialog.exec():
            ...
            createTask(2, file_id, tool_id, material_id, name, note)
            addTask.delay(1)
            self.refreshLayout()
    ...
    def refreshLayout(self):
        ...
        tasks = getAllTasksFromUser(2, 'all')
        for task in tasks:
