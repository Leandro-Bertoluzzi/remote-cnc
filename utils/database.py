...
def update_task(
    ...
    task_repository = TaskRepository(session)
    task = task_repository.update_task(task_id, user_id, file_id, tool_id, material_id, name, note, priority)
    return task
...
def update_task_status(
    ...
    task_repository = TaskRepository(session)
    task = task_repository.update_task_status(task_id, status, admin_id, cancellation_reason)
    return task
